...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="tasklist-entry";
    label.innerText=taskString;
    label.className='task tasklist-label';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="tasklist-checkbox";
    editInput.type="text";
    editInput.className="task tasklist-input";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.tasklist-input');
    var label=listItem.querySelector(".tasklist-label");
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".tasklist-checkbox");
